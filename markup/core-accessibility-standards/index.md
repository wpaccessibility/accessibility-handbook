...
<table>
    ...
    <tr>
        ...
        <tr><td>Anchors with meaningful off-page HREF values that are <strong>not</strong> renderable</td>
...
- [Keyboard testing techniques](https://webaim.org/techniques/keyboard/)
- [Where to place focus when deleting a thing](https://adrianroselli.com/2023/08/where-to-put-focus-when-deleting-a-thing.html#:~:text=TL%3BDR%3A%20When%20deleting%20something,control%20or%20its%20grouping%20container.)
